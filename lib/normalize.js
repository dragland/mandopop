...
const REGISTER_LABEL = /\((?:coll|sl\b|slang|dialect|vulgar|Tw\b|HK\b|Cantonese|Beijing|Internet|old\b|archaic|literary|classical|humorous|derog|onom|loanword|euphemism|courteous|honorific|dated|obsolete)/i;
const RESTRICTION_LABEL = /\((?:of |used |usu\.|when |before |after |followed |preceded |in |as |more\)|one's|sb's|attached|placed)/i;
...
const TRAILING_MARK = /\((?:abbr|honorific|humble|deferential)\b[^)]*\)$/i;
